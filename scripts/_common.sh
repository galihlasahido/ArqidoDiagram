...
PROJECT_FILE="$PROJECT_DIR/ArqidoDiagram.xcodeproj"
SCHEME="ArqidoDiagram"
APP_NAME="ArqidoDiagram"
BUNDLE_ID="com.arqido.ArqidoDiagram"
...
# Regenerates ArqidoDiagram.xcodeproj from project.yml if it's missing
